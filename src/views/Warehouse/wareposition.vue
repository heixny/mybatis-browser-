<template>
    <div>
        ...
        <el-card>
            <el-row :gutter="20">
                <el-col :span="4">
                    <el-input placeholder="请输入库位编号" v-model="searchNo" clearableclear="getList">
                    </el-input>
                </el-col>
                <el-col :span="4">
                    <el-input placeholder="请输入库位名称" v-model="searchName" clearableclear="getList">
                    </el-input>
                </el-col>
                <el-col :span="2">
            ...
            <el-table :data="List" style="width: 100%; margin-top:10px;" border
                ...
                <!-- 数据区开始 -->
                <el-table-column label="库位编号" width="110" prop="positionNo" />
                <el-table-column label="库位名称" width="120" prop="positionName" />
                <el-table-column label="库位描述" width="120" prop="positionDesc" />
                <el-table-column label="所属仓库" width="100" prop="wareName" />
                <el-table-column label="仓库代码" width="100" prop="wareNo" v-if="false" />
                <el-table-column label="所属区域" width="100" prop="areaName" />
                <el-table-column label="区域代码" width="100" prop="areaNo" v-if="false" />
                <el-table-column label="录入者" width="100" prop="userName" />
                <el-table-column label="用户id" width="100" prop="inputer" v-if="false" />
            ...
            <el-dialog title="提示" :visible.sync="showAddBox" width="60%" :before-close="handleClose"
                ...
                <el-form :model="Form" :rules="metetrialFormRules" ref="metetrialFormRef">
                    <el-form-item label="库位名称" prop="positionName" style="margin-top:5px;">
                        <el-input v-model="Form.positionName"></el-input>
                    </el-form-item>
                    <el-form-item label="库位描述" prop="positionDesc" style="margin-top:5px;">
                    ...
                    <el-form-item label="所属区域" prop="areaNo" style="margin-top:5px;">
                        <el-select v-model="Form.areaNo" placeholder="请选择区域">
            ...
            <el-dialog title="提示" :visible.sync="showEditBox" width="60%" :before-close="handleClose"
                ...
                <el-form :model="Info" :rules="metetrialFormRules" ref="metetrialFormRef">
                    <el-form-item label="区域编号" prop="positionNo" style="margin-top:5px;">
                        <el-input v-model="Info.positionNo" :readonly="true"></el-input>
                    </el-form-item>
                    <el-form-item label="区域名称" prop="positionName" style="margin-top:5px;">
                        <el-input v-model="Info.positionName"></el-input>
                    </el-form-item>
                    <el-form-item label="区域描述" prop="positionDesc" style="margin-top:5px;">
                        <el-input v-model="Info.positionDesc"></el-input>
                    </el-form-item>
                    <el-form-item label="所属仓库" prop="wareNo" style="margin-top:5px;">
                    ...
                    <el-form-item label="所属区域" prop="areaNo" style="margin-top:5px;">
                        <el-select v-model="Info.areaNo" placeholder="请选择区域">
                            <el-option v-for="item in area" :key="item.value" :label="item.text" :value="item.value+''">
                            </el-option>
                        </el-select>
                    </el-form-item>
...
<script>
import { getList, save, dele } from '@/api/wareposition.js'
import { getware,getarea } from "@/api/option.js";
export default {
    name: 'wareposition',
    data() {
        return {
            ...
            searchName: '',
            List: [],                                      //存储主要信息
            Form: { positionName: '', positionDesc: '',wareNo: '',areaNo: ''  }, //添加框信息
            Info: { id:'',positionName: '', positionDesc: '',wareNo: '',areaNo: ''  },//编辑框信息
            metetrialFormRules: {
            },
            ware: [],
            area: [],
    ...
    methods: {
        getList() {
            const param = { page: this.pageNo, limit: this.pageSize, positionNo: this.searchNo, positionName: this.searchName };
