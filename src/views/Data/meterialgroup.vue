<template>
    <div>
        <el-breadcrumb separator-class="el-icon-arrow-right">
            ...
            <el-breadcrumb-item>物料组管理</el-breadcrumb-item>
        </el-breadcrumb>
        <el-card>
            <el-row :gutter="20">
                <el-col :span="4">
                    <el-input placeholder="请输入物料组编号" v-model="searchNo" clearableclear="getList">
                    </el-input>
                </el-col>
                <el-col :span="4">
                    <el-input placeholder="请输入物料组名称" v-model="searchName" clearableclear="getList">
                    </el-input>
                </el-col>
                <el-col :span="2">
            ...
            <el-table :data="List" style="width: 100%; margin-top:10px;" border
                ...
                <!-- 数据区开始 -->
                <el-table-column label="物料组编号" width="105" prop="groupNo" />
                <el-table-column label="物料组名称" width="140" prop="groupName" />
                <el-table-column label="物料组描述" width="100" prop="groupDesc" />
            ...
            <el-dialog title="提示" :visible.sync="showAddBox" width="60%" :before-close="handleClose"
                ...
                <el-form :model="Form" :rules="metetrialFormRules" ref="metetrialFormRef">
                    <el-form-item label="物料组名称" prop="groupName" style="margin-top:5px;">
                        <el-input v-model="Form.groupName"></el-input>
                    </el-form-item>
                    <el-form-item label="物料组描述" prop="groupDesc" style="margin-top:5px;">
            ...
            <el-dialog title="提示" :visible.sync="showEditBox" width="60%" :before-close="handleClose"
                ...
                <el-form :model="Info" :rules="metetrialFormRules" ref="metetrialFormRef">
                    <el-form-item label="物料组编号" prop="groupNo" style="margin-top:5px;">
                        <el-input v-model="Info.groupNo" :readonly="true"></el-input>
                    </el-form-item>
                    <el-form-item label="物料组名称" prop="groupName" style="margin-top:5px;">
...
<script>
import { getList, save, dele } from '@/api/meterialgroup.js'
export default {
    name: 'meterialgroup',
    data() {
        return {
            ...
            searchName: '',
            List: [],                                      //存储主要信息
            Form: { groupName: '', groupDesc: '', ruleNo: '' }, //添加框信息
            Info: { id:'',groupName: '', groupDesc: '', ruleNo: '' },//编辑框信息
            metetrialFormRules: {
            },
        }
    },
    methods: {
        getList() {
            const param = { page: this.pageNo, limit: this.pageSize, groupNo: this.searchNo, groupName: this.searchName };
