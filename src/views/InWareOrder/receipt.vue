        ...
        <el-card>
            ...
            <el-dialog title="提示" :visible.sync="showAddBox" width="60%" :before-close="handleClose"
                ...
                <el-form :model="userForm" :inline="true" class="demo-form-inline">
                    <el-form-item label="申请单号" prop="orderNo" style="margin-top:5px;">
                        <el-input v-model="userForm.orderNo" :readonly="true"></el-input><br />
                    </el-form-item>
                    <el-form-item label="申请日期" prop="requireTime" style="margin-top:5px;">
                        <el-input v-model="userForm.requireTime" :readonly="true"></el-input>
                    </el-form-item>
                </el-form>
                <el-form :model="userForm" :inline="true" class="demo-form-inline">
                    ...
                    <el-form-item label="业务类型" prop="serviceType" style="margin-top:5px;">
                        <el-input v-model="userForm.serviceType" :readonly="true"></el-input>
                    </el-form-item>
                </el-form>
                <el-form :model="userForm" :inline="true" class="demo-form-inline">
                    <el-form-item label="来源单号" prop="sourceNo" style="margin-top:5px;">
                        <el-input v-model="userForm.sourceNo" :readonly="true"></el-input>
                    </el-form-item>
                    <el-form-item label="来源类型" prop="sourceType" style="margin-top:5px;">
                        <el-input v-model="userForm.sourceType" :readonly="true"></el-input>
                    </el-form-item>
                </el-form>
                <!-- table -->
                ...
                <span slot="footer" class="dialog-footer">
                    <el-button @click="commit('false')">拒绝申请</el-button>
                    <el-button type="primary" @click="commit('true')">同意申请</el-button>
                </span>
            </el-dialog>
            <!-- 编辑弹框 -->
